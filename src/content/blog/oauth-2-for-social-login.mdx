...
For Google social login, the roles are:
...
After receiving approved provider data, the service usually uses an identifier, such as an email address or provider-specific user ID, to create or match an internal account.
