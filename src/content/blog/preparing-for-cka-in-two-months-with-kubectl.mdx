---
title: "Preparing for CKA in 2 Months with kubectl"
...
The goal was to verify that the concepts behind each problem were understood instead of memorizing answers.
...
The exact questions are unlikely to appear on the exam. Practice until each problem can be solved with the official documentation.
...
During practice, I concentrated on:
...
I wanted to pass the CKA and use Kubernetes in a project.
...
The CKA is a hands-on exam, which suits Kubernetes beginners.
Its documentation access and flexible rescheduling and cancellation policy support practical Kubernetes learning.

The exam fee and remote exam environment are the main drawbacks.

A strong CKA score can indicate practical Kubernetes skills.
CKAD and CKS are possible next steps, depending on the intended learning path.
