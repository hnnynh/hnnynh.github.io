---
title: "Replacing AWS Access Keys with IRSA on EKS"
...
IRSA scopes AWS access to the workload's ServiceAccount:
...
EKS Pod Identity also associates an IAM role with a Kubernetes ServiceAccount. Its implementation is specific to EKS.

## Applying IRSA

Replace access-key-based environment variables or mounted credentials with a ServiceAccount mapped to an IAM role. The process follows AWS documentation for assigning IAM roles to Kubernetes ServiceAccounts.
