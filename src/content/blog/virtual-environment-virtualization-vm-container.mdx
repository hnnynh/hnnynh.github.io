...
VMs receive virtualized hardware and run their own OS kernel. Containers share the host OS kernel and isolate processes at the OS level.
...
All of these create isolation, though they do so at different layers.
